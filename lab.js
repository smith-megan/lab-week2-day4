...
/*
  ...
  Have the values to those keys be strings that are equal to your favorite thing 
  in that category.
*/
...
const ginger = new Cat('ginger', "4 months", "orange tabby")
...
const Herman= new Wizard("Herman", 103, "Leviosa")
// console.log(Herman)
Herman.castSpell()
//////////////////////////// PROBLEM 10 ////////////////////////////
/*
...
//Code Here
let samsung= new Phone('Samsung', 'S8', 10, "purple", 2000)
let pixel= new Phone('Pixel', "three", 250, "green", 1000)
let iphone= new Phone('Apple', "two", 2, "yellow", 10000)
// console.log(samsung)
// console.log(pixel)
// console.log(iphone)
/* 
...
//Code Here
let myFirstVehicle= new Vehicle(10, "rust", 100000)
...
//Code Here 
let myFirstMotorCycle = new Motorcycle(100, "black", 10000, "chopper", "very cool")
// console.log(myFirstMotorCycle)
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorCycle.moveBy(10)
console.log(myFirstMotorCycle)
/*
...
class Boat extends Vehicle {
  constructor(capacity,color,mileage,name,type,isSeaworthy) {
    ...
    checkSeaworthiness(isSeaworthy){
      ...
      console.log(`the ${this.color+" "+this.type+" "+this.name} is seaworthy!`)} else{
...
//Code Here
let myFirstBoat=new Boat(2000, "white & black", 300, "Titanic", "steamer", false)
/*
